...
export function FinalCTA() {
  return (
    <section
      aria-labelledby="kurum-cta-heading"
    ...
    >
      ...
      <div className="relative mx-auto flex max-w-[var(--max-content)] flex-col items-center gap-8 px-[var(--space-gutter)] py-24 text-center md:py-32">
        ...
        >
          @kurumsal.com e-postanızla kayıt olun. LiseUP Kurum Success ekibi kısa bir doğrulama
          yapar, hesabınız Discover katmanında hemen aktif olur.
        </p>
