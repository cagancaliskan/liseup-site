...
export function FinalCTA() {
  return (
    <section
      aria-labelledby="okul-cta-heading"
    ...
    >
      ...
      <div className="relative mx-auto flex max-w-[var(--max-content)] flex-col items-center gap-8 px-[var(--space-gutter)] py-24 text-center md:py-32">
        ...
        >
          Öğrencinizin potansiyelini görün.
        </h2>
        ...
        >
          4 aylık pilot programıyla öğrenci aktivitesini somut veriyle belgeleyin, veliye güçlü
          rapor sunun, kurumlarla bağlantı kurun.
        </p>
