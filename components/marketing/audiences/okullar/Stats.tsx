...
const STATS: Stat[] = [
  { raw: 4, display: "4", caption: "ay pilot program süresi" },
  { raw: 3, display: "3", caption: "pilot şehir, İstanbul, Ankara, İzmir" },
  { raw: 6, display: "6", caption: "pilot okul kontenjanı" },
];
...
export function Stats() {
  return (
    <section
      aria-label="Okul pilot rakamları"
