...
const STATS: Stat[] = [
  { raw: 3, display: "3", caption: "dakikada profil açabilirsin" },
  { raw: 100, display: "%100", caption: "liseli için ücretsiz, sonsuza kadar" },
  { raw: 7, display: "7", caption: "gün önceden 18-yaş hatırlatması" },
];
...
export function Stats() {
  return (
    <section aria-label="Liseli platform rakamları" className="border-y border-[var(--rule)] bg-[var(--surface-0)]">
