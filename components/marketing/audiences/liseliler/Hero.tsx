...
import { LiseliMock } from "./LiseliMock";

const CHIPS = ["14–18 yaş", "Sonsuza kadar ücretsiz", "Veli onaylı"];

export function Hero() {
  return (
    <section
      aria-labelledby="liseli-hero-heading"
        ...
        <div className="flex flex-col gap-8">
          ...
          <div className="flex items-center gap-2.5">
            ...
            <span className="font-mono text-[11px] uppercase tracking-[0.18em] text-[var(--ink-2)]">
              LiseUP · Liseliler için · 14–18 yaş
            </span>
          </div>

          {/* Display headline */}
          <h1
            id="liseli-hero-heading"
          ...
          >
            ...
            Ekibin yok.
            <br />
            <strong className="font-black text-[var(--color-brand-500)]">Şimdi var.</strong>
          </h1>

          {/* Lede */}
          <p className="max-w-[44ch] font-sans text-[17px] leading-relaxed text-[var(--ink-2)]">
            Profilini kur, projeni paylaş, ekibini bul. Kurumların seni keşfetmesine izin ver;
            velinin onayıyla, sonsuza kadar ücretsiz.
          </p>
          ...
          <div className="flex flex-wrap items-center gap-4">
            ...
            <MagneticButton href="#nasil-calisir" variant="outline">
              Nasıl çalışır?
            </MagneticButton>
          </div>
