...
export default function BasariHikayesiStub() {
  return (
      ...
      <div className="mt-10 flex flex-col items-start gap-5 rounded-2xl border border-border/80 bg-card p-8">
        ...
        <div>
          ...
          <h1 className="mt-2 font-display text-[28px] font-bold leading-tight text-foreground">
            Bu hikaye Eylül 2026 sonrasında yayınlanır.
          </h1>
          <p className="mt-3 text-[15px] leading-6 text-muted-foreground">
            Pilot lansmanıyla birlikte gerçek liseli başarı hikayeleri ve kurucu
            ekip içerikleri yayına girer. Şu an bu sayfa bir placeholder.
          </p>
        </div>
        <Button asChild>
          <Link href="/basari-hikayeleri">Tüm hikayeler</Link>
        </Button>
      </div>
    </div>
  );
